...
{
    cerr << "Decompressor constructor begin\n";
    Vint llcodelens(288);
...
{
    cerr << "BuildCodeList begin\n";

    if (node->type == 1)
    {
        cerr << "BuildCodeList type 1\n";
        prefix->push_back(0);
